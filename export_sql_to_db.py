...
try:
    ...
    CREATE TABLE Members (
        ...
        Phone TEXT,
        Address TEXT,
        MembershipDate TEXT DEFAULT CURRENT_DATE
    );
    """)
    ...
    CREATE TABLE Users (
        ...
        Role TEXT CHECK (Role IN ('Admin', 'Librarian', 'Member'))
    );
    """)
...
('admin1', 'adminpass', 'Admin');
    ...
    (1, 1, '2025-02-25', DATE('2025-02-25', '+14 days'), 'Issued'),
    (2, 2, '2025-02-26', DATE('2025-02-26', '+14 days'), 'Issued'),
    (3, 3, '2025-02-27', DATE('2025-02-27', '+14 days'), 'Issued'),
    (4, 4, '2025-02-28', DATE('2025-02-28', '+14 days'), 'Returned'),
    (5, 5, '2025-02-20', DATE('2025-02-20', '+14 days'), 'Returned'),
    (6, 6, '2025-02-21', DATE('2025-02-21', '+14 days'), 'Overdue'),
    (7, 7, '2025-02-22', DATE('2025-02-22', '+14 days'), 'Issued'),
    (8, 8, '2025-02-23', DATE('2025-02-23', '+14 days'), 'Issued'),
    (9, 9, '2025-02-24', DATE('2025-02-24', '+14 days'), 'Issued'),
    (10, 10, '2025-02-19', DATE('2025-02-19', '+14 days'), 'Returned'),
    (11, 11, '2025-02-20', DATE('2025-02-20', '+14 days'), 'Overdue'),
    (12, 12, '2025-02-21', DATE('2025-02-21', '+14 days'), 'Issued'),
    (13, 13, '2025-02-22', DATE('2025-02-22', '+14 days'), 'Issued'),
    (14, 14, '2025-02-23', DATE('2025-02-23', '+14 days'), 'Returned'),
    (15, 15, '2025-02-24', DATE('2025-02-24', '+14 days'), 'Returned'),
    (16, 16, '2025-02-19', DATE('2025-02-19', '+14 days'), 'Overdue'),
    (17, 17, '2025-02-20', DATE('2025-02-20', '+14 days'), 'Returned'),
    (18, 18, '2025-02-21', DATE('2025-02-21', '+14 days'), 'Returned'),
    (19, 19, '2025-02-22', DATE('2025-02-22', '+14 days'), 'Returned'),
    (20, 20, '2025-02-23', DATE('2025-02-23', '+14 days'), 'Issued'),
    (21, 21, '2025-02-24', DATE('2025-02-24', '+14 days'), 'Issued'),
    (22, 22, '2025-02-19', DATE('2025-02-19', '+14 days'), 'Overdue'),
    (23, 23, '2025-02-20', DATE('2025-02-20', '+14 days'), 'Issued'),
    (24, 24, '2025-02-21', DATE('2025-02-21', '+14 days'), 'Issued'),
    (25, 25, '2025-02-22', DATE('2025-02-22', '+14 days'), 'Issued'),
    (26, 26, '2025-02-23', DATE('2025-02-23', '+14 days'), 'Issued'),
    (27, 27, '2025-02-24', DATE('2025-02-24', '+14 days'), 'Issued'),
    (28, 28, '2025-02-19', DATE('2025-02-19', '+14 days'), 'Returned'),
    (29, 29, '2025-02-20', DATE('2025-02-20', '+14 days'), 'Reserved'),
    (30, 30, '2025-02-21', DATE('2025-02-21', '+14 days'), 'Returned');
""")
